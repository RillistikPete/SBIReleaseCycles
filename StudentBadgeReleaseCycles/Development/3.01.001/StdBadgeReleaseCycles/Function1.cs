...
namespace StdBadgeReleaseCycles
{
    public class Function1
    {
        ...
        public async Task Run([TimerTrigger("0 */5 6-22 * * 0-5")]TimerInfo myTimer, ILogger log)
        {
            log.LogInformation("C# HTTP trigger function processed a request.");
            System.Net.ServicePointManager.FindServicePoint(new Uri(Environment.GetEnvironmentVariable("EdFiApiBaseUri"))).ConnectionLeaseTimeout = (60*1000);
            System.Net.ServicePointManager.FindServicePoint(new Uri(Environment.GetEnvironmentVariable("ApiBaseUri"))).ConnectionLeaseTimeout = (60*1000);
            //=====
